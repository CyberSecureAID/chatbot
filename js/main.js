 ...
 *  Edita el objeto CONFIG para personalizar sin tocar el resto.
 * ──────────────────────────────────────────────────────────────
 */
...
const CONFIG = {
  ...
  /** Chips iniciales — deja el array vacío [] para no mostrar ninguno */
  welcomeChips: [],
...
async function handleUserMessage(text) {
  ...
  if (!response) {
    response = 'No encontré información sobre eso. Puedes escribirnos a contacto@empresa.com';
  }
